...
ln -sf "$REPO_DIR/.config/herdr/config.toml" "$HOME/.config/herdr/config.toml"
...
cp -f "$REPO_DIR/.tmux-tools/agent" "$TMUX_TOOLS_DIR/agent"
cp -f "$REPO_DIR/.tmux-tools/agent-common" "$TMUX_TOOLS_DIR/agent-common"
cp -f "$REPO_DIR/.tmux-tools/hermes" "$TMUX_TOOLS_DIR/hermes"
cp -f "$REPO_DIR/.tmux-tools/kubectl" "$TMUX_TOOLS_DIR/kubectl"
cp -f "$REPO_DIR/.tmux-tools/remote-edit" "$TMUX_TOOLS_DIR/remote-edit"
cp -f "$REPO_DIR/.tmux-tools/st" "$TMUX_TOOLS_DIR/st"
cp -f "$REPO_DIR/.tmux-tools/tmux-file-picker" "$TMUX_TOOLS_DIR/tmux-file-picker"
cp -f "$REPO_DIR/.tmux-tools/tmux-copy-osc52" "$TMUX_TOOLS_DIR/tmux-copy-osc52"
cp -f "$REPO_DIR/.tmux-tools/tmux-nested-toggle" "$TMUX_TOOLS_DIR/tmux-nested-toggle"
...
chmod +x "$TMUX_TOOLS_DIR/agent"
chmod +x "$TMUX_TOOLS_DIR/hermes"
chmod +x "$TMUX_TOOLS_DIR/kubectl"
chmod +x "$TMUX_TOOLS_DIR/remote-edit"
chmod +x "$TMUX_TOOLS_DIR/st"
chmod +x "$TMUX_TOOLS_DIR/tmux-file-picker"
chmod +x "$TMUX_TOOLS_DIR/tmux-copy-osc52"
chmod +x "$TMUX_TOOLS_DIR/tmux-nested-toggle"
